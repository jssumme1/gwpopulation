...
__all__ = [
    ...
    "BaseSmoothedPrimarySecondaryDistribution",
    "SinglePeakIdenticalSmoothedPrimarySecondaryDistribution",
...
class SinglePeakIndependentSmoothedPrimarySecondaryDistribution(BaseSmoothedPrimarySecondaryDistribution):
    ...
    lam_2: float
        Fraction of black holes in the Gaussian component (secondary mass).
    mpp_1: float
        Mean of the Gaussian component for more massive black hole.
    mpp_2: float
        Mean of the Gaussian component for less massive black hole.
    sigpp_1: float
        Standard deviation of the Gaussian component for more massive black hole.
    sigpp_2: float
        Standard deviation of the Gaussian component for less massive black hole.
    gaussian_mass_maximum: float, optional
        Upper truncation limit of the Gaussian component. (default: 100)
    delta_m: float
